      ...
      min-h-screen'>
        ...
        z-10'>
            ...
            <div className='mb-10 text-center md:text-left'>
               ...
               <p className='text-slate-500'>Select your portal to 
                ...
                {portalOptions.map((portal)=>(
                    ...
                    transition-all duration-300 hover:border-indigo-400 hover:bg-indigo-50'>
                        <div className='relative z-10 flex items-center justify-between gap-4 sm:gap-5'>
                            ...
                            group-hover:text-indigo-600 mb-1 transition-colors'>{portal.title}</h3>
                            <ArrowRightIcon className='w-4 h-4 text-slate-400 grpup-hover:text-indigo-600
            ...
            <div className='mt-12 text-create md:text-left text-sm
            text-slate-400'>
                <p>© {new Date().getFullYear()} Annanya. All rights reserved.</p>
            </div>
