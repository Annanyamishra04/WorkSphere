    ...
    <div className="animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <div className="relative flex-1">
          ...
          className="w-full pl-10!" onChange={(e)=>setSearch(e.target.value)}
          value={search}/>
      ...
      {loading ? (
        <div className="flex justify-center p-12">
          <div className="animate-spin h-8 w-8 border-indigo-600 
      ...
      {showCreateModal &&(
        ...
        flex items-start justify-center p-4 overflow-y-auto" onClick={()=>
          showCreateModal(false)}>
            ...
            max-w-3xl my-8 animate-fade-in" onClick={(e)=> e.stopPropagation()}>
              <div className="flex items-center justify-between p-6 pb-0">
                ...
                <button  onClick ={()=> setShowCreateModal(false)} className="p-2 rounded-lg
          ...
          setEditEmployee(null)}>
            ...
            max-w-3xl my-8 animate-fade-in" onClick={(e)=>e.stopPropagation()} >
              <div className="flex items-center justify-between p-6 pb-0">
                ...
                <button  onClick ={()=> setEditEmployee(null)} className="p-2 rounded-lg
                hover:bg-slate-100 transition-colors text-slate-400
                hover:text-slate-600">
                  <X className="w-5 h-5"/>
