  ...
  return (
    <div className='max-w-2xl mx-auto p-8 bg-white animate-fade-in'>
      ...
      <div className='grid grid-cols-2 gap-6 mb-8'>
        ...
        <div className='rounded-xl border border-slate-200 oveflow-hidden mb-8'>
          <table className='w-full text-sm'>
            <thead>
              <tr className='bgs-slate-50'>
                <th className='text-left py-3 px4 text-xs text-slate-500 uppercase tracking-wider'>Description</th>
