  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl animate-fade-in">
        ...
        <div className="card p-5 sm:p-6">
            ...
            text-slate-700">
                ...
                <div className="sm:col-span-2">
                    ...
                    <input name="bio" required defaultValue={initialData?.bio}
                    rows={3} className="resize-none" placeholder="Breif description..."/>
                </div>
        ...
        <div className="card p-5 sm:p-6">
            ...
            text-slate-700">
                <div className="sm:col-span-2">
                    <label className="block mb-2">Worl Email</label>
