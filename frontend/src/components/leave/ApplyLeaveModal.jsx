...
const ApplyLeaveModal = ({open, onClose, onSuccess}) => {
  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center justify-center p-4
    bg-black/40 backdrop-blur-sm' onClick={onClose}> 

    <div className='relative bg-white rounded-2xl rounded-2xl shadow-2xl w-full
