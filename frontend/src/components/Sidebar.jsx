...
const Sidebar = () => {
        ...
        <div className='flex-1 px-3 space-y-0.5 overflow-y-auto'>
            {navItems.map((item)=>{
                ...
                return(
                    ...
                    {`group flex items-center gap-3 px-3 py-2.5 rounded-md text-[13px] font-medium 
                    transition-all duration-150 relative ${isActive? "bg-indigo-500/12 text-indigo-300" :
                        "text-slate-300 hover:text-white hover:bg-white/4"}`}>


                    {isActive && <div className='absolute left-0 top1/2
  ...
  return (
    ...
    fixed top-4 left-4 z-50 p-2 bg-slate-900 text-white rounded-lg
